...
with val_depart as (
    select
        ...
        case when cib.annee_scolaire = '2022 - 2023' then 'Valeur de départ' else cib.annee_scolaire end as annee_scolaire,
        taux,
        cib.cible,
        case 
...
select
    ...
    taux,
    cible,
    case when annee_scolaire = 'Valeur de départ' then concat(cast(taux *100 as decimal (5,1)), '%') else taux_cible end as taux_cible
from val_depart